...
public interface UserApproveMapper {
  ...
  @Mapping(target = "id", expression = "java(IdEncoder.encode(detail.getId()))")
  @Mapping(target = "userId", expression = "java(detail.getUserId() != null ? IdEncoder.encode(detail.getUserId()) : null)")
